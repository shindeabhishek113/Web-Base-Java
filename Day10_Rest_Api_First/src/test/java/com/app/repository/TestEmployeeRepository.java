...
class TestEmployeeRepository {
	...
	void testAddEmployees() {
		List<Employee> emps = List.of(
				new Employee("Abhishek", "Shinde", "abhi@gmail.com", "12345", "Pune", LocalDate.of(2020, 10, 20), 45678),
				new Employee("Pushpadant", "bhai", "pusha@gmail.com", "2345", "Mumbai", LocalDate.of(2021, 1, 24), 55678));
